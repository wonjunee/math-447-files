...
for running=1:50
    ...
    phi1=pi/2*(running-1)*2/110;
    phi2=pi/2*(running-1)*2/110;
    phi3=pi/2*(running-1)*2/110;
    phi4=pi/2*(running-1)*2/110;
    fff=pi/2*(running-1)*2/110;
    theta1=0;
    theta2=1/2*pi;
    theta3=pi;
    theta4=3/2*pi;
...
title(sprintf('delta t_1 vs. Error Magnification Factor phi=%f',fff))
